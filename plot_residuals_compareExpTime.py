...
_stamp_pat = 'data/sci_mock_{}_onlyHost_{}000s.fits'
_psfresid_pat = 'runJWST/SDSS_z7_{}000s/mcmc_out_mock_{}_point_source_subtracted.fits'
...
def plot_models(quasar, ii, save_name=None):
    ...
    plot_panels = [stamp, 'Point Source\nSubtracted']
    #plot_panels = [stamp_smooth,resid_smooth_sm,resid_smooth_SN]
    ...
    grid[0].set_title('1ks',fontsize=10)
    grid[1].set_title('5ks',fontsize=10)
    grid[2].set_title('10ks',fontsize=10)
    grid[3].set_title('True Image (10ks)',fontsize=10)
