...
for ll,filt in enumerate(['F115W','F150W','F200W','F277W','F356W','F444W']):
    ...
    ax2[1,0].plot(df_T['BtoT'],fit_sers[df[filt]==True],marker=markers[ll],label=filt,markerfacecolor='w',markeredgewidth=1.5,ls='')
    #ax2[1,0].errorbar(df_T['BtoT'],fit_sers[df[filt]==True],err_sers[df[filt]==True],fmt=markers[ll],label=filt,markerfacecolor='w',markeredgewidth=1.5)
