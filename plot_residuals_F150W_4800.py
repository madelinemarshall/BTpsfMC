...
_psfresid_pat = 'runJWST/SDSS_z7_F150W_4800s/mcmc_out_mock_{}_point_source_subtracted.fits'
...
def plot_models(quasar, save_name=None):
    ...
    flux_ratio=psfresid[95,95]/quasardata[95,95]
...
if __name__ == '__main__':
    ...
    pp.savefig('SDSS_z7_residual_F150W_4800s.pdf')
    pp.show() 
    pp.close(fig)
